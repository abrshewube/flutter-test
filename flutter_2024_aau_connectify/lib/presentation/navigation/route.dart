...
Route<dynamic> controller(RouteSettings settings) {
  switch (settings.name) {
    ...
    case profileUser:
      return MaterialPageRoute(builder: (context) =>  const ProfileUser(name: 'John Doe', id: '123456', userName: 'johndoe', fieldOfStudy: 'Computer Science', image: 'assets/images/profile.jpg'));
